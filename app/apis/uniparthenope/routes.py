...
from app.apis.uniparthenope.v1.general_v1 import CurrentAA, RecentAD, InfoCourse, InfoPersone, PersonalImage, ProfImage, RSSNews
...
ns.add_resource(CheckAppello, '/v1/students/checkAppello/<cdsId>/<adId>/<matId>', methods=['GET'])
