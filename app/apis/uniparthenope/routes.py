...
ns.add_resource(MyExams, '/v2/students/myExams/<matId>', methods=['GET'])
...
ns.add_resource(RSSAvvisi, '/v1/general/avvisi/<int:size>', methods=['GET'])
ns.add_resource(Privacy, '/v1/general/privacy/<int:size>', methods=['GET'])
ns.add_resource(Anagrafica, '/v1/general/anagrafica/<Id>', methods=['GET'])
ns.add_resource(Sedi, '/v1/general/sedi', methods=['GET'])
